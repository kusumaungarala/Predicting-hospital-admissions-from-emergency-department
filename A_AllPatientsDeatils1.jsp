    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="AdminLogin.jsp"><strong>Helathcare Server </strong></a></li>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="717" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="709"><div align="right"><a href="E_AllPatientsDeatils.jsp" class="style85 style93">Back</a></div></td>
            </tr>
          </table>
