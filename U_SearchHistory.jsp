...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33 style33">User <span class="style19 style19"><%=(String)application.getAttribute("uname")%></span>'s Search History.. </span></h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <table width="446" border="2" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr>
              ...
              <td  width="154" valign="middle" height="39" style="color: #2c83b0;"><div align="center" class="style59 style58 style60"><strong>Keyword</strong></div></td>
            ...
            <%
						...
						{	String user=(String)application.getAttribute("uname");
						   	String query="select * from search where username='"+user+"'"; 
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="U_SearchHistory.jsp">Home</a></li>
