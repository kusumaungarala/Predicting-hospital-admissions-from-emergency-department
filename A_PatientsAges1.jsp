...
<%@ page import="java.security.*,java.security.DigestInputStream,java.math.BigInteger"%>	
		  ...
		  String s1="";
		   String query="select * from patients where id="+id+" "; 
							...
							//String content = new String(Base64.decode(s1.getBytes()));
						%>
		  <table width="664" cellspacing="2" cellpadding="2">
            ...
            <tr>
              ...
              <td><textarea name="textarea" cols="100" rows="25" id="inputTextToSave"><%=s1%></textarea></td>
            </tr>
            <tr>
          ...
          <table width="717" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="709"><div align="right"><a href="A_PatientsAges.jsp" class="style85 style93">Back</a></div></td>
            </tr>
          </table>
     </div>
      </div>
