    ...
    <div class="main">
        ...
        <div class="content">
            <div class="content_resize">
                <div class="mainbar">
                    <div class="article">
                        <h2><span class="style43">Welcome To Data User mobile number verification.....</span></h2>
...
<%! 
    ...
    private boolean storeOtpInDatabase(String mobile, String otp) {
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Using_DataMining", "root", "root");
            PreparedStatement pst = conn.prepareStatement("UPDATE user SET otp=? WHERE mobile=?");
            pst.setString(1, otp);  
