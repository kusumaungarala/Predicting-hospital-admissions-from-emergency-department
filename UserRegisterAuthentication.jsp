...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style48">User Registration Status..</span></h2>
          <div class="clr"></div>
          <div>
            <label for="name">
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,status,image,otp) values(?,?,?,?,?,?,?,?,?,?)");
