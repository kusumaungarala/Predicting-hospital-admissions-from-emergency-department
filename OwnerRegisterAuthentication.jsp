...
<head>
<title>Data Owner Registration Status..</title>
...
.style50 {color: #FF00FF; font-size: 25px;}
-->
</style>
</head>
<body>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style50">Data Owner Registration Status..</span></h2>
          <div class="clr"></div>
          <div>
            <label for="name">
            ...
            <p align="left"><a href="DO_Register.jsp" class="style21">Back</a></p>
            <p>
              <%
...
PreparedStatement ps=connection.prepareStatement("insert into owner(username,password,email,mobile,address,dob,gender,status,image,otp) values(?,?,?,?,?,?,?,?,?,?)");
            ...
            <p class="style46">&nbsp;</p>
            <p><a href="DO_Login.jsp" class="style21">Back</a></p>
            <%
